    ...
    e.onmessage = function (t) {
        ...
        if (i.event && r) r._signal(i.event, i.data);
            ...
            if (n[i.command]) n[i.command].apply(n, i.args);
                ...
                if (!e.hasOwnProperty(i.command) || typeof e[i.command] !== 'function') {
                    throw new Error("Unknown or disallowed command: " + i.command);
                }
                ...
                switch (g) {
                    ...
                    case ">":
                        switch (m) {
                            ...
                            case a:
                                m === a && (d = s),
                                    m == l ? (i.warning('attribute "' + d + '" missed quot(")!!'), n.add(s, d.replace(/&#?\w+;/g, r), t)) : (i.warning('attribute "' + d + '" missed value!! "' + d + '" instead!!'), n.add(d, d, t));
                                break;
                            case f:
        ...
        return (
            (s.prototype.parseFromString = function (e, t) {
                ...
                return (
                    ...
                    /\/x?html?$/.test(t) && ((c.nbsp = "\u00a0"), (c.copy = "\u00a9"), (l[""] = "http://www.w3.org/1999/xhtml")),
