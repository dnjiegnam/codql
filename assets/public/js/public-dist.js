...
!(function (t, e) {
  ...
  function t(t) {
    ...
    var e = this.hashtag;
    if (!1 !== e && "twitter" !== e && "facebook" !== e && "instagram" !== e)
  ...
  return (
    (t.prototype = {
      ...
      parse: function (t) {
        for (
          var e = this.getHtmlParser().parse(t),
            a = 0,
            n = [],
            i = 0,
            r = e.length;
          ...
          var o = e[i],
            s = o.getType();
          "element" === s && "a" === o.getTagName()
            ? o.isClosing()
              ? (a = Math.max(a - 1, 0))
              : a++
            : "text" === s &&
              0 === a &&
              ((o = this.parseText(o.getText(), o.getOffset())),
              n.push.apply(n, o));
        }
      ...
      compactMatches: function (t) {
        ...
        for (var e = 0; e < t.length - 1; e++)
          for (
            var a = t[e], n = a.getOffset() + a.getMatchedText().length;
            e + 1 < t.length && t[e + 1].getOffset() <= n;
      ...
      parseText: function (t, e) {
        e = e || 0;
        for (
          var a = this.getMatchers(), n = [], i = 0, r = a.length;
          i < r;
          i++
        ) {
          for (var o = a[i].parseMatches(t), s = 0, l = o.length; s < l; s++)
            o[s].setOffset(e + o[s].getOffset());
          n.push.apply(n, o);
        }
        return n;
      },
      link: function (t) {
        if (!t) return "";
        for (
          var e = this.parse(t), a = [], n = 0, i = 0, r = e.length;
          i < r;
          i++
        ) {
          var o = e[i];
          a.push(t.substring(n, o.getOffset())),
            a.push(this.createMatchReturnVal(o)),
      ...
      createMatchReturnVal: function (e) {
        var a;
        return "string" ==
          typeof (a = this.replaceFn ? this.replaceFn.call(this, this, e) : a)
          ? a
          : !1 === a
          ? e.getMatchedText()
          : (a instanceof t.HtmlTag ? a : e.buildTag()).toAnchorString();
      },
      getHtmlParser: function () {
        return (
          this.htmlParser || (this.htmlParser = new t.htmlParser.HtmlParser())
        );
      },
      ...
      getTagBuilder: function () {
        return (
          this.tagBuilder ||
          (this.tagBuilder = new t.AnchorTagBuilder({
    ...
    (t.Util = {
      ...
      ellipsis: function (t, e, a) {
        return t.length > e
          ? t.substring(0, e - (a = null == a ? ".." : a).length) + a
          : t;
      },
      ...
      remove: function (t, e) {
        for (var a = t.length - 1; 0 <= a; a--)
          !0 === e(t[a]) && t.splice(a, 1);
      },
      splitAndCapture: function (t, e) {
        for (var a, n = [], i = 0; (a = e.exec(t)); )
          n.push(t.substring(i, a.index)),
            n.push(a[0]),
    ...
    (t.AnchorTagBuilder = t.Util.extend(Object, {
      ...
      createAttrs: function (t, e) {
        return (
          (e = { href: e }),
          (t = this.createCssClass(t)) && (e.class = t),
          this.newWindow && (e.target = "_blank"),
          e
        );
      },
      ...
      doTruncate: function (e) {
        ...
        var a,
          n = a.length;
        return "smart" === (a = a.location)
          ? t.truncate.TruncateSmart(e, n, "..")
          : "middle" === a
          ? t.truncate.TruncateMiddle(e, n, "..")
          : t.truncate.TruncateEnd(e, n, "..");
      },
    })),
    (t.htmlParser.HtmlParser = t.Util.extend(Object, {
      ...
      parse: function (t) {
        for (
          var e, a, n = this.htmlRegex, i = 0, r = [];
          null !== (h = n.exec(t));
          ...
          var o = h[0],
            ...
            d = h.index,
            h = t.substring(i, d);
          h && ((e = this.parseTextAndEntityNodes(i, h)), r.push.apply(r, e)),
            s
              ? r.push(this.createCommentNode(d, o, s))
              : r.push(this.createElementNode(d, o, l, c)),
            (i = d + o.length);
        }
        return (
          i < t.length &&
            (a = t.substring(i)) &&
            ((e = this.parseTextAndEntityNodes(i, a)), r.push.apply(r, e)),
          r
        );
      },
      parseTextAndEntityNodes: function (e, a) {
        for (
          var n = [],
            i = t.Util.splitAndCapture(a, this.htmlCharacterEntitiesRegex),
            r = 0,
            o = i.length;
          r < o;
          r += 2
          ...
          s && (n.push(this.createTextNode(e, s)), (e += s.length)),
            l && (n.push(this.createEntityNode(e, l)), (e += l.length));
        }
        return n;
      },
    ...
    (t.match.Url = t.Util.extend(t.match.Match, {
      ...
      getUrl: function () {
        ...
        return (
          this.protocolRelativeMatch ||
            ...
            ((t = this.url = "http://" + t), (this.protocolPrepended = !0)),
          t
        );
      },
      getAnchorHref: function () {
      ...
      getAnchorText: function () {
        ...
        return (
          ...
          this.stripPrefix && (t = this.stripUrlPrefix(t)),
          this.removeTrailingSlash(t)
        );
      },
    ...
    (t.matcher.Email = t.Util.extend(t.matcher.Matcher, {
      matcherRegex:
        ...
        (e = new RegExp("[" + n + "\\-;:&=+$.,]+@")),
        (a = t.RegexLib.domainNameRegex),
        (n = t.RegexLib.tldRegex),
        new RegExp([e.source, a.source, "\\.", n.source].join(""), "gi")),
      parseMatches: function (e) {
        for (
          var a, n = this.matcherRegex, i = this.tagBuilder, r = [];
          null !== (a = n.exec(e));
    ...
    (t.matcher.Hashtag = t.Util.extend(t.matcher.Matcher, {
      matcherRegex: new RegExp(
        "#[_" + t.RegexLib.alphaNumericCharsStr + "]{1,139}",
        "g"
      ),
      nonWordCharRegex: new RegExp(
        "[^" + t.RegexLib.alphaNumericCharsStr + "]"
      ),
      constructor: function (e) {
        t.matcher.Matcher.prototype.constructor.call(this, e),
          (this.serviceName = e.serviceName);
      },
      parseMatches: function (e) {
        for (
          var a = this.matcherRegex,
    ...
    (t.matcher.Phone = t.Util.extend(t.matcher.Matcher, {
      matcherRegex:
        /(?:(\+)?\d{1,3}[-\040.])?\(?\d{3}\)?[-\040.]?\d{3}[-\040.]\d{4}/g,
      parseMatches: function (e) {
        for (
          var a, n = this.matcherRegex, i = this.tagBuilder, r = [];
          null !== (a = n.exec(e));
    ...
    (t.matcher.Twitter = t.Util.extend(t.matcher.Matcher, {
      matcherRegex: new RegExp(
        "@[_" + t.RegexLib.alphaNumericCharsStr + "]{1,20}",
        "g"
      ),
      nonWordCharRegex: new RegExp(
        "[^" + t.RegexLib.alphaNumericCharsStr + "]"
    ...
    (t.matcher.Url = t.Util.extend(t.matcher.Matcher, {
      ...
      parseMatches: function (e) {
        for (
          ...
          t.matcher.UrlMatchValidator.isValid(o, s) &&
            !(
              (0 < h && "@" === d) ||
              (0 < h && c && this.wordCharRegExp.test(d))
            ) &&
            (this.matchHasUnbalancedClosingParen(o)
              ? (o = o.substr(0, o.length - 1))
              : -1 < (d = this.matchHasInvalidCharAfterTld(o, s)) &&
                (o = o.substr(0, d)),
            r.push(
              new t.match.Url({
                tagBuilder: i,
                matchedText: o,
                offset: h,
                urlMatchType: s ? "scheme" : l ? "www" : "tld",
                url: o,
                protocolUrlMatch: !!s,
                protocolRelativeMatch: !!c,
                stripPrefix: n,
              })
            ));
        }
      ...
      matchHasInvalidCharAfterTld: function (t, e) {
        ...
        return (
          ...
          null ===
          (e =
            /^((.?\/\/)?[A-Za-z0-9\u00C0-\u017F\.\-]*[A-Za-z0-9\u00C0-\u017F\-]\.[A-Za-z]+)/.exec(
              t
            ))
            ? -1
            : ((a += e[1].length),
              (t = t.slice(e[1].length)),
              /^[^.A-Za-z:\/?#]/.test(t) ? a : -1)
        );
      },
    })),
    (t.matcher.UrlMatchValidator = {
      ...
      isValidUriScheme: function (t) {
        return (
          "javascript:" !==
            (t = t.match(this.uriSchemeRegex)[0].toLowerCase()) &&
          "vbscript:" !== t
        );
      },
    ...
    (t.truncate.TruncateMiddle = function (t, e, a) {
      ...
      var n = e - a.length,
        i = "";
      return (
        0 < n && (i = t.substr(-1 * Math.floor(n / 2))),
        (t.substr(0, Math.ceil(n / 2)) + a + i).substr(0, e)
      );
    }),
    (t.truncate.TruncateSmart = function (t, e, a) {
      ...
      var r,
        ...
        c =
          ((o = {}),
          (r = (s = r = t).match(/^([a-z]+):\/\//i)) &&
            ((o.scheme = r[1]), (s = s.substr(r[0].length))),
          (r = s.match(/^(.*?)(?=(\?|#|\/|$))/i)) &&
            ((o.host = r[1]), (s = s.substr(r[0].length))),
          (r = s.match(/^\/(.*?)(?=(\?|#|$))/i)) &&
            ((o.path = r[1]), (s = s.substr(r[0].length))),
          (r = s.match(/^\?(.*?)(?=(#|$))/i)) &&
            ((o.query = r[1]), (s = s.substr(r[0].length))),
          (r = s.match(/^#(.*?)$/i)) && (o.fragment = r[1]),
          o);
      if (
        (!c.query ||
          ((d = c.query.match(/^(.*?)(?=(\?|\#))(.*?)$/i)) &&
            ((c.query = c.query.substr(0, d[1].length)), (t = i(c)))),
        t.length <= e)
      )
        return t;
      if (
        (c.host && ((c.host = c.host.replace(/^www\./, "")), (t = i(c))),
        t.length <= e)
      )
        return t;
      var d = "";
      if ((c.host && (d += c.host), d.length >= l))
        return (
          c.host.length == e ? c.host.substr(0, e - a.length) + a : n(d, l)
        ).substr(0, e);
      if (
        ((i = ""),
        c.path && (i += "/" + c.path),
        ...
        if (l <= (d + i).length)
          return (d + i).length == e
            ? (d + i).substr(0, e)
            : (d + n(i, l - d.length)).substr(0, e);
        d += i;
      }
      if (c.fragment) {
        if (l <= (d + (i = "#" + c.fragment)).length)
          return (d + i).length == e
            ? (d + i).substr(0, e)
            : (d + n(i, l - d.length)).substr(0, e);
        d += i;
      ...
      return d.length <= e
        ? d
        : ((h = ""),
          0 < l && (h = d.substr(-1 * Math.floor(l / 2))),
          (d.substr(0, Math.ceil(l / 2)) + a + h).substr(0, e));
    }),
    t
  );
}),
  (function (t) {
    ...
    function n(a) {
      t.each(e.opened().reverse(), function () {
        return a.isDefaultPrevented() || !1 !== this[o[a.type]](a)
          ? void 0
    ...
    (e.prototype = {
      ...
      setup: function (e, a) {
        ...
        return (
          ...
          n.$instance.on(n.closeTrigger + "." + n.namespace, function (e) {
            var a = t(e.target);
            (("background" === n.closeOnClick && a.is("." + n.namespace)) ||
      ...
      getContent: function () {
        ...
        var a = this,
          ...
          o = n[a.type];
        if (
          (!o && r in n && ((o = n[r]), (r = a.target && i)),
          (r = r || e("href") || ""),
          !o)
        )
          for (var s in n) a[s] && ((o = n[s]), (r = a[s]));
        if (!o) {
          var l = r;
          r = null;
          if (
      ...
      setContent: function (e) {
        var a = this;
        return (
          (e.is("iframe") || 0 < t("iframe", e).length) &&
            a.$instance.addClass(a.namespace + "-iframe"),
      ...
      open: function (e) {
        var a = this;
        if (
          (a.$instance.hide().appendTo(a.root),
          !((e && e.isDefaultPrevented()) || !1 === a.beforeOpen(e)))
        ) {
          e && e.preventDefault();
          var n = a.getContent();
          if (n)
      ...
      resize: function (t, e) {
        ...
        t &&
          ...
          1 <
            (a = Math.max(
              t / parseInt(this.$content.parent().css("width"), 10),
              e / parseInt(this.$content.parent().css("height"), 10)
            )) &&
            this.$content
              .css("width", t / a + "px")
              .css("height", e / a + "px"));
            ...
            e &&
              ...
              t.each(e.attributes, function () {
                if ((a = this.name.match(i))) {
                  var e = this.value,
                    a = t.camelCase(a[1]);
                  if (0 <= t.inArray(a, n.functionAttributes))
                    e = new Function(e);
                  else
                    try {
                      e = t.parseJSON(e);
        ...
        attach: function (e, a, n) {
          ...
          return (
            e.on(s.openTrigger + "." + s.namespace, s.filter, function (o) {
              var l = t.extend(
                  { $source: e, $currentTarget: t(this) },
                  i.readElementConfig(e[0], s.namespace),
                  i.readElementConfig(this, s.namespace),
                  n
                ),
                c = r || t(this).data("featherlight-persisted") || new i(a, l);
              "shared" === c.persist
                ? (r = c)
                : !1 !== c.persist && t(this).data("featherlight-persisted", c),
          ...
          e.autoBind &&
            ...
            t(document).on("click", e.autoBind, function (a) {
              a.isDefaultPrevented() ||
                "featherlight" === a.namespace ||
                (a.preventDefault(),
                e.attach(t(a.currentTarget)),
                t(a.target).trigger("click.featherlight"));
            }));
        },
        _callbackChain: {
          onKeyUp: function (e, a) {
            return 27 === a.keyCode
              ? (this.closeOnEsc && t.featherlight.close(a), !1)
              : e(a);
          },
  ...
  (function (t, e) {
    ...
    function n(n, i, r) {
      ...
      (o.id = r),
        ...
        (o.breakpointNames = ""),
        (o.columns = {}),
        (o.plugins = e.footable.plugins.load(o));
      var s = o.options,
        l = s.classes,
        c = s.events,
        d = s.triggers,
      ...
      return (
        ...
        (o.init = function () {
          var a = t(e),
            n = t(o.table);
          if ((e.footable.plugins.init(o), n.hasClass(l.loaded)))
            o.raise(c.alreadyInitialized);
          else {
            ...
            s.breakpoints))
              o.breakpoints.push({ name: i, width: s.breakpoints[i] }),
                (o.breakpointNames += i + " ");
            o.breakpoints.sort(function (t, e) {
              ...
              n
                ...
                .on(d.initialize, function () {
                  n.removeData("footable_info"),
                    n.data("breakpoint", ""),
                    n.trigger(d.resize),
                    n.removeClass(l.loading),
                    n.addClass(l.loaded).addClass(l.main),
                    o.raise(c.initialized);
                })
                .unbind(d.redraw)
          ...
          o.hasAnyBreakpointColumn() &&
            ...
            e
              ...
              .on("click.footable", function (a) {
                e.is(".breakpoint") &&
                  t(a.target).is("td,th,." + l.toggle) &&
                  t(this).trigger(d.toggleRow);
              }));
        }),
        ...
        (o.getColumnData = function (e) {
          ...
          if (1 < d) {
            ...
            p = (p = p || "").split(",");
            for (var f = 0; f < d; f++)
              r.matches.push(f + u), p.length > f && (r.names[f + u] = p[f]);
          } else r.matches.push(u);
          r.hide.default =
            "all" === a.data("hide") || 0 <= t.inArray("default", n);
          var g,
            m = !1;
          for (g in s.breakpoints)
            (r.hide[g] = "all" === a.data("hide") || 0 <= t.inArray(g, n)),
              (m = m || r.hide[g]);
          return (
            (r.hasBreakpoint = m),
            o.raise(c.columnData, { column: { data: r, th: e } }).column.data
          );
        }),
        ...
        (o.calculateWidth = function (t, e) {
          return "function" == typeof s.calculateWidthOverride
            ? s.calculateWidthOverride(t, e)
            : (e.viewportWidth < e.width && (e.width = e.viewportWidth),
              e.parentWidth < e.width && (e.width = e.parentWidth),
              e);
        }),
        ...
        (o.resize = function () {
          ...
          if (e.is(":visible"))
            if (o.hasAnyBreakpointColumn()) {
              ...
              if (
                (e.data("footable_info", a),
                o.raise(c.resizing, { old: n, info: a }),
                !n || (n && n.width && n.width !== a.width))
              ) {
                ...
                e
                  ...
                  l !== u &&
                    (e.trigger(d.redraw),
                    o.raise(c.breakpoint, { breakpoint: l, info: a }));
              }
        ...
        (o.redraw = function () {
          ...
          e
            ...
            .each(function () {
              ...
              "" !== a &&
                (!1 === n.hide[a]
                  ? c.addClass("footable-visible").show()
                  : c.removeClass("footable-visible").hide()),
            ...
            e
              .find("> tbody > tr." + l.detailShow + ":visible")
              .each(function () {
                var e = t(this).next();
        ...
        (o.toggleDetail = function (e) {
          ...
          a.hasClass(l.detailShow)
            ? (a.removeClass(l.detailShow),
              e.hasClass(l.detail) && e.hide(),
              o.raise(c.rowCollapsed, { row: a[0] }))
            : (o.createOrUpdateDetailRow(a[0]),
              a.addClass(l.detailShow).next().show(),
              o.raise(c.rowExpanded, { row: a[0] }));
        }),
        (o.removeRow = function (e) {
          var a = e.jquery ? e : t(e);
          e = (a = a.hasClass(l.detail) ? a.prev() : a).next();
          !0 === a.data("detail_created") && e.remove(),
            a.remove(),
            o.raise(c.rowRemoved);
        }),
        (o.appendRow = function (e) {
          (e = e.jquery ? e : t(e)),
            t(o.table).find("tbody").append(e),
            o.redraw();
        }),
            ...
            a.find("> td:hidden").each(function () {
              ...
              return (
                null != c &&
                  t(this).is(":empty") &&
                  ((r = t(
                    "." + l.detailInnerValue + '[data-bind-value="' + c + '"]'
                  )),
                  t(this).html(t(r).contents().detach())),
                !1 !== a.isEditable &&
                  (a.isEditable || 0 < t(this).find(":input").length) &&
                  (null == c &&
                    ((c = "bind-" + t.now() + "-" + e),
                    t(this).attr("data-bind-name", c)),
                  (s = t(this).contents().detach())),
                (s = s || t(this).contents().clone(!0, !0)),
                i.push({
                  name: n,
                  value: o.parse(this, a),
                  display: s,
                  group: a.group,
        ...
        (o.raise = function (e, a) {
          !0 === o.options.debug &&
            "function" == typeof o.options.log &&
            o.options.log(e, "event");
          var n = { ft: o };
          return (
            t.extend(!0, n, (a = a || {})),
            (e = t.Event(e, n)).ft || t.extend(!0, e, n),
            t(o.table).trigger(e),
            e
          );
        }),
        (o.reset = function () {
          ...
          e
            ...
            .data("breakpoint", "")
            .removeClass(l.loading)
            .removeClass(l.loaded),
            e
              .find(s.toggleSelector)
              .unbind(d.toggleRow)
              .unbind("click.footable"),
        ...
        (o.toggleInput = function (e) {
          ...
          null == a ||
            (null !=
              (a = t(
                "." + l.detailInnerValue + '[data-bind-value="' + a + '"]'
              )) &&
              (t(e).is(":visible")
                ? t(a).is(":empty") || t(e).html(t(a).contents().detach())
                : t(e).is(":empty") || t(a).html(t(e).contents().detach())));
        }),
        o.init(),
        o
      );
    ...
    e.footable = {
      options: {
        ...
        createGroupedDetail: function (t) {
          for (
            var e = { _none: { name: null, data: [] } }, a = 0;
            t.length > a;
            a++
          ) {
            var n = t[a].group;
            null !== n
              ? (n in e ||
                  (e[n] = { name: t[a].groupName || t[a].group, data: [] }),
                e[n].data.push(t[a]))
              : e._none.data.push(t[a]);
          }
          return e;
        },
              ...
              for (var l = 0; s[o].data.length > l; l++) {
                ...
                e.append(
                  t("<div></div>")
                    ...
                    .append(
                      t("<div></div>")
                        .addClass(r.detailInnerValue)
                        .attr("data-bind-value", s[o].data[l].bindName)
                        .append(s[o].data[l].display)
                    )
                );
              }
            }
      ...
      plugins: {
        _validate: function (t) {
          return "string" != typeof (t = new t()).name
            ...
            ? (!0 === e.footable.options.debug &&
                console.log(
                  'Validation succeeded for plugin "' + t.name + '".',
                  t
                ),
              !0)
            : (!0 === e.footable.options.debug &&
        ...
        register: function (a, n) {
          e.footable.plugins._validate(a) &&
            (e.footable.plugins.registered.push(a),
            "object" == typeof n && t.extend(!0, e.footable.options, n));
        },
        load: function (t) {
          for (
            var a, n = [], i = 0;
            e.footable.plugins.registered.length > i;
            i++
          )
            try {
    ...
    e.footable.plugins.register(function () {
      ...
      (e.name = "Footable Filter"),
                  ...
                  "footable_initialized.filtering": function () {
                    var n = t(a.table),
                      i = {
                        ...
                        timeout:
                          n.data("filter-timeout") || a.options.filter.timeout,
                        minimum:
                          n.data("filter-minimum") || a.options.filter.minimum,
                        disableEnter:
                          n.data("filter-disable-enter") ||
        ...
        (e.filter = function (a) {
          ...
          ((a = i.raise("footable_filtering", { filter: a, clear: !a })) &&
            !1 === a.result) ||
              ...
              : ((o = a.filter.split(" ")),
                ...
                t.each(o, function (t, e) {
                  e &&
                    ...
                    (n = n.filter(i.options.filter.filterFunction)));
                }),
                n.each(function () {
        ...
        (e.showRow = function (e, a) {
          var n = t(e),
            ...
            r = t(a.table);
          n.is(":visible") ||
            (r.hasClass("breakpoint") &&
            n.hasClass("footable-detail-show") &&
            i.hasClass("footable-row-detail")
              ? (n.add(i).show(), a.createOrUpdateDetailRow(e))
              : n.show());
        });
    }, a);
  })(jQuery, window),
    ...
    function a(e) {
      ...
      (this.pageNavigation = a.pageNavigation || e.options.pageNavigation),
        ...
        (this.limitNavigation = parseInt(
          a.limitNavigation || e.options.limitNavigation || n.limitNavigation,
          10
        )),
    ...
    e.footable.plugins.register(function () {
      ...
      (e.name = "Footable Paginate"),
        ...
        (e.setupPaging = function () {
          ...
          (n.pageInfo = new a(n)),
            e.createPages(n, i),
            e.createNavigation(n, i),
            e.fillPage(n, i, n.pageInfo.currentPage);
        }),
        (e.createPages = function (e, a) {
          ...
          l.each(function (t, e) {
            o.push(e),
              t === r - 1
                ? (i.pages.push(o), (r = ++n * i.pageSize), (o = []))
                : t >= l.length - (l.length % i.pageSize) && s.push(e);
          }),
            0 < s.length && i.pages.push(s),
            i.currentPage >= i.pages.length &&
              (i.currentPage = i.pages.length - 1),
        ...
        (e.createNavigation = function (a) {
          ...
          if (0 === i.length) {
            if (
              0 <
                (i = t(a.pageInfo.pageNavigation)).parents("table:first")
                  .length &&
              i.parents("table:first") !== t(a.table)
            )
              return;
            1 < i.length &&
              !0 === a.options.debug &&
          ...
          0 !== i.length &&
            ...
            i
              ...
              .on("click", "a[data-page]", function (r) {
                r.preventDefault();
                var o,
                  s = t(this).data("page");
                r = n.currentPage;
                if (
                  ("first" === s
                    ...
                    : "limit-prev" === s
                    ? ((r = -1),
                      (o = i.find(".footable-page:first a").data("page")),
                      e.createLimited(i, n, o - n.limitNavigation),
                      e.setPagingClasses(i, n.currentPage, n.pages.length))
                    : "limit-next" === s
                    ? ((r = -1),
                      (o = i.find(".footable-page:last a").data("page")),
                      e.createLimited(i, n, o + 1),
                      e.setPagingClasses(i, n.currentPage, n.pages.length))
                    : (r = s),
                  0 <= r)
                ) {
        ...
        (e.createLimited = function (t, e, a) {
          ...
          0 === a ? i.hide() : i.show(),
            a + e.limitNavigation >= e.pages.length ? t.hide() : t.show();
        }),
        (e.paginate = function (a, n) {
          ...
          o.currentPage !== n &&
            ...
            ((r = a.raise("footable_paging", { page: n, size: o.pageSize })) &&
              !1 === r.result) ||
              (e.fillPage(a, i, n),
              o.control.find("li").removeClass("active disabled"),
              e.setPagingClasses(o.control, o.currentPage, o.pages.length)));
        }),
        ...
        (e.name = "Footable Sortable"),
                ...
                .on({
                  "footable_initialized.sorting": function () {
                    ...
                    if (!1 !== r.data("sort"))
                      for (var s in (r
                        ...
                        .each(function () {
                          var e = t(this);
                          !0 === n.columns[e.index()].sort.ignore ||
                            e.hasClass(o.sortable) ||
                            (e.addClass(o.sortable),
                            t("<span />").addClass(o.indicator).appendTo(e));
                        }),
                      r
                        .find(
                  ...
                  "footable_redrawn.sorting": function () {
                    ...
                    0 <= i.data("sorted") &&
                      i.find("> thead > tr:last-child > th").each(function (n) {
                        var i = t(this);
                        return (
                          (i.hasClass(r.sorted) || i.hasClass(r.descending)) &&
                            e.doSort(n),
                          a
                        );
                      });
                  ...
                  "footable_column_data.sorting": function (e) {
                    ...
                    (e.column.data.sort = e.column.data.sort || {}),
                      ...
                      (a = a.data("sort-match") || 0) >=
                        e.column.data.matches.length && (a = 0),
          ...
          (e.doSort = function (n, i) {
            ...
            if (!1 !== t(r.table).data("sort")) {
              ...
              ((n = r.raise(h.sorting, {
                ...
                (i = i === a ? c.hasClass(d.sorted) : i)
                  ? c.removeClass(d.descending).addClass(d.sorted)
                  : c.removeClass(d.sorted).addClass(d.descending),
                e.sort(r, s, l, i),
              ...
              n
                ...
                .each(function () {
                  ...
                  return (
                    ...
                    (n.next().hasClass(e.options.classes.detail) &&
                      (o = n.next().get(0)),
                    (o = { row: n, detail: o }),
                    i !== a && (o.value = e.parse(this.cells[i.sort.match], i)),
                    r.push(o),
                    !0)
                  );
                })
          ...
          (e.sort = function (t, a, n, i) {
            ...
            for (var s = 0; r.length > s; s++)
              a.append(r[s].row), null !== r[s].detail && a.append(r[s].detail);
          });
      },
      {
        sort: !0,
  ...
  (function (t) {
    ...
    (r.prototype = {
      ...
      isType: function (t, a) {
        return (
          (a = a || this.options.states)[
            (t = t || this.state(e, e, a).props.type)
          ] && (t = a[t].props.type),
      ...
      wrapElement: function (e) {
        ...
        return (
          this.wrapperElement.length ||
            ...
            !1 !==
              (n =
                !0 === n ? this.wrapperElement.outerWidth() !== a && a : n) &&
              this.wrapperElement.css("width", n)),
          this.wrapperElement
        );
      },
        ...
        n &&
          ...
          (a =
            "left" === this.options.toggle.position
              ? ((e = a), (n += this.toggleElement.outerWidth()))
              : ((e = n), a)),
          e <= a && this.toggleEvent(t));
      },
    }),
  ...
  jQuery(document).ready(function (t) {
    jQuery().datepicker &&
      t("input.wpas-date").length &&
      "date" != t("input.wpas-date:first").prop("type") &&
      t("input.wpas-date").datepicker();
  }),
  (function (t) {
    "use strict";
    t(function () {
      ...
      t(".wpas-modal-trigger").featherlight(),
        t("#wpas_form_registration").on(
          "change",
          'input[name="wpas_pwdshow[]"]',
          function (e) {
            e.preventDefault(),
              t("#wpas_password").hideShowPassword(t(this).prop("checked"));
          }
        ),
        "undefined" != typeof wpas &&
          ...
          (a = t(
            '<div class="wpas-help-block" id="wpas_emailvalidation"></div>'
          ))
            .appendTo(t("#wpas_email_wrapper"))
            .hide(),
    ...
    t(function () {
      ...
      "undefined" != typeof wpas &&
        ...
        (o = {
          ...
          ticket_replies_nonce: wpas.front_replies_nonce,
        }),
        (s = t(".wpas-pagi-text").outerHeight()),
        t(".wpas-pagi-loader").css({ width: s, height: s }),
        n.on("click", function (s) {
          s.preventDefault(),
            (o.ticket_replies_total =
              e.find("tr.wpas-reply-single").length - 1),
  ...
  jQuery(document).ready(function (t) {
    jQuery().select2 &&
      t("select.wpas-select2").length &&
      t("select.wpas-select2").select2();
  }),
  (function (t) {
    "use strict";
    t(function () {
      t(".wpas-reply-content").length &&
        t(".wpas-reply-content").each(function (t, e) {
          "undefined" != typeof wpas &&
            stringToBool(wpas.useAutolinker) &&
            (e.innerHTML = Autolinker.link(e.innerHTML));
        });
        ...
        "undefined" != typeof tinyMCE
          ? t(".wpas-form").on("submit", function (e) {
              ...
              if (!(n.is(":checked") || ("" !== i && null !== i)))
                return (
                  t(tinyMCE.activeEditor.getBody()).css(
                    "background-color",
                    "#ffeeee"
                  ),
                  alert(wpas.translations.emptyEditor),
                  t(tinyMCE.activeEditor.getBody()).css("background-color", ""),
          ...
          : t(".wpas-form").on("submit", function (e) {
              var a = t('[type="submit"]', t(this)),
                n = a.attr("data-onsubmit")
                  ? a.attr("data-onsubmit")
                  : wpas.translations.onSubmit;
        ...
        ? (function () {
            ...
            e.footable(),
              e.footable().on("footable_filtering", function (t) {
                ...
                e &&
                  0 < e.length &&
                  ((t.filter += t.filter && 0 < t.filter.length ? " " + e : e),
                  (t.clear = !t.filter));
              });
            var i = [],
              r = "";
            a.each(function (e, a) {
              (a = t(a).find(".wpas-label-status").text()),
                -1 == i.indexOf(a) &&
                  (i.push(a),
              ...
              n.on("change", function (a) {
                a.preventDefault(),
                  e.trigger("footable_filter", {
                    filter: t("#wpas_filter").val(),
                  });
              }),
              t(".wpas-clear-filter").on("click", function (t) {
                t.preventDefault(),
                  n.val(""),
                  e.trigger("footable_clear_filter");
              });
          })()
        : i.hide();
    });
        ...
        (e = t("#wpas_files")).on("change", function (a) {
          ...
          t.each(e.get(0).files, function (t, e) {
            ...
            0 !== n.length &&
              ...
              clearFileInput(e[0])),
            parseInt(e.get(0).files.length) >
              parseInt(wpas.fileUploadMax, 10) &&
              (alert(wpas.fileUploadMaxError), clearFileInput(e[0]));
        }),
        t("body").on("click", ".btn_delete_attachment", function (e) {
          e.preventDefault();
          var a = t(this),
            n = t(
              '<span class="spinner" style="visibility: visible;margin-left: 0;float: left;margin-top: 0;"></span>'
            );
          ...
          t.post(
            ...
            function (t) {
              a.show(),
                n.remove(),
                t.success && a.closest("li").html(t.data.msg);
            }
          );
        }),
        t(
          "#wpas-new-reply .wpas-auto-delete-attachments-container input[type=checkbox]"
        ).on("change", function () {
          var e = t(this),
            a = t(
              '<span class="spinner" style="visibility: visible;margin-left: 0;float: left;margin-top: 0;"></span>'
    ...
    t(function () {
      function e(e) {
        e.removeClass("is-expanded").addClass("is-collapsed"),
          t(".card").not(e).removeClass("is-inactive"),
          e.trigger("card_collapsed");
      }
      (Window.close_card = e),
        t("body").on("click", ".wpas_cards .card .js-expander", function () {
          ...
          a.hasClass("is-collapsed")
            ? (n
              ...
              n.not(a).hasClass("is-inactive") ||
                n.not(a).addClass("is-inactive"))
            : e(a);
        }),
